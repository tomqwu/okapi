/* This is Martin Porter's coding (current Nov 2001) of the English
   stemmer with the function name changed to portrealstem() for
   use by the psstem() function in our porter.c source.
*/
...
/* The main part of the stemming algorithm starts here. b is a buffer
   ...
   should be done before portrealstem(...) is called.
*/
...
/* In portrealstem(p,i,j), p is a char pointer, and the string to be stemmed is from
...
int portrealstem(char * p, int i, int j)
